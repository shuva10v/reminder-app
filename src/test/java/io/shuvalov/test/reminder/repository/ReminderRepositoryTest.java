...
public class ReminderRepositoryTest {
	...
	void searchForReadyNotifications() {
		...
		reminder1.setTime(LocalDateTime.of(2022, 10, 10, 15, 5, 5, 0));
		reminder1 = repository.save(reminder1);

		Reminder reminder2 = new Reminder();
		reminder2.setName("test2");
		reminder2.setTime(LocalDateTime.of(2022, 10, 11, 15, 5, 5, 0));
		reminder2 = repository.save(reminder2);

		Reminder reminder3 = new Reminder();
		reminder3.setName("test2");
		reminder3.setTime(LocalDateTime.of(2022, 10, 12, 15, 5, 5, 0));
		reminder3 = repository.save(reminder3);

		Collection<Reminder> list = repository.findAllByNotifiedIsFalseAndTimeLessThanEqual(LocalDateTime
				.of(2022, 10, 9, 15, 5, 5, 0));
		Assertions.assertEquals(0, list.size());

		list = repository.findAllByNotifiedIsFalseAndTimeLessThanEqual(LocalDateTime
				.of(2022, 10, 10, 17, 5, 5, 0));
		Assertions.assertEquals(1, list.size());
		Assertions.assertEquals(List.of(reminder1), list);

		list = repository.findAllByNotifiedIsFalseAndTimeLessThanEqual(LocalDateTime
				.of(2022, 10, 11, 17, 5, 5, 0));
	...
	void reminderOwnership() {
		...
		reminder2.setTime(LocalDateTime.of(2022, 10, 10, 15, 5, 5, 0));
